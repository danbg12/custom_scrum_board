...
import static custom.scrum.board.bugtracking.task.TaskController.REST_URL;
import static custom.scrum.board.bugtracking.task.TaskService.CANNOT_ASSIGN;
import static custom.scrum.board.bugtracking.task.TaskService.CANNOT_UN_ASSIGN;
import static custom.scrum.board.bugtracking.task.TaskTestData.NOT_FOUND;
import static custom.scrum.board.bugtracking.task.TaskTestData.*;
